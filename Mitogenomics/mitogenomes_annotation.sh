...
# after checking the BioProject and BioSample of each newly annotated mitogenome,
# directly submit the files *.sqn or *.gbf to NCBI-GenBank by electronic mail at: gb-sub@ncbi.nlm.nih.gov
