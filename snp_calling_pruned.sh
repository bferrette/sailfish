...
angsd -b $4/bamlist -ref $1 -GL 1 -P 12 -out $4/sailfish.pruned \
  -remove_bads 1 -uniqueOnly 1 -only_proper_pairs 1 -baq 2 \
  ...
  -doMaf 2 -doPost 1 -minMaf 0.025 -SNP_pval 1e-6 \
  -doGeno 8 -geno_minDepth 3 -doGlf 2 \
  -sites ld_pruned.sites \
  &> $4/angsd.log
